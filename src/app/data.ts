...
export const MOCK_PROPERTIES: Property[] = [
  {
    ...
    agent: {
      ...
      agency: "Houzii Premier",
      listings: 25,
    },
    description:
      "This contemporary masterpiece in Lekki Phase 1 offers unparalleled luxury. Featuring smart home integration, a private swimming pool, and an elevator, it's designed for the discerning homeowner. The expansive master suite includes a walk-in closet and a private balcony with city views.",
  ...
  },
  {
    ...
    agent: {
      ...
      agency: "Banana Island Estates",
      listings: 12,
    },
    description:
      "Experience absolute exclusivity in this Banana Island mansion. Situated on the waterfront, this property offers panoramic ocean views, a private jetty, and sprawling lush gardens. Every corner reflects opulence and architectural brilliance.",
  ...
  },
  {
    ...
    agent: {
      ...
      agency: "PH Prime Properties",
      listings: 18,
    },
    description:
      "Located in the serene G.R.A Phase 2, this semi-detached home is perfect for a growing family. It features spacious rooms, a modern kitchen, and a well-landscaped backyard.",
  ...
  },
  {
    ...
    agent: {
      ...
      agency: "Abuja Luxury Realty",
      listings: 8,
    },
    description:
      "A state-of-the-art smart villa in the heart of Maitama. This villa redefines modern living with voice-controlled systems, a cinema room, and a gym.",
  ...
  },
  {
    ...
    agent: {
      ...
      agency: "Lagos Lifestyle Rentals",
      listings: 34,
    },
    description:
      "Ideal for professionals, this serviced apartment in Victoria Island offers convenience and style. Fully furnished with high-end appliances and access to a shared gym and pool.",
  ...
  },
  {
    ...
    agent: {
      name: "Chinedu O.",
      avatar: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&q=80&w=150",
      agency: "Ikoyi Prime Properties",
      listings: 12,
    },
    description:
      "Stunning penthouse in Ikoyi with breathtaking views of the Lagos lagoon. Features high ceilings, floor-to-ceiling windows, and a private wraparound terrace.",
  ...
  },
  {
    ...
    description:
      "Your home away from home. This premium shortlet offers comfort and luxury with a stunning ocean view. Perfect for vacations or business trips.",
