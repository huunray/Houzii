...
import { Eye, EyeOff, ArrowRight, ShieldCheck, ArrowLeft, Check, X } from 'lucide-react';
...
export const CreateAccount: React.FC<CreateAccountProps> = ({ onContinue, onLogin }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-white">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden rounded-r-[32px]">
        <ImageWithFallback
          src="https://images.unsplash.com/photo-1638454795595-0a0abf68614d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBtb2Rlcm4lMjBhcGFydG1lbnQlMjBpbnRlcmlvciUyMGxpdmluZyUyMHJvb218ZW58MXx8fHwxNzczNjI4MDYzfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
          alt="Beautiful luxury apartment"
        ...
        <Link to="/" className="absolute top-8 right-8 flex items-center gap-2 text-white/70 hover:text-white transition-colors bg-white/10 hover:bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
          <ArrowLeft className="w-4 h-4" />
          <span className="text-sm font-bold">Go back to website</span>
        </Link>
        <div className="absolute bottom-16 left-8 right-8">
          ...
          >
            Nigeria's first trust-verified real estate ecosystem. Every listing verified, every transaction protected.
          </motion.p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-16">
        ...
        >
          ...
          <h1 className="text-slate-900 font-black text-3xl mb-2">Create Account</h1>
          <p className="text-slate-400 font-medium mb-10">Start your journey with Houzii today.</p>
