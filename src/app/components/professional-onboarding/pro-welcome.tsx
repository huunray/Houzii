...
import { ShieldCheck, ArrowRight, Sparkles, Wrench, Award } from 'lucide-react';
...
export const ProWelcome: React.FC<ProWelcomeProps> = ({ userName, onGoToDashboard }) => {
  return (
      ...
      >
        ...
        >
          ...
          <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-green-50 border border-green-200 rounded-full mb-6">
            ...
            <span className="text-green-600 font-black text-sm uppercase tracking-widest">Tier 1 - Browse Only</span>
          </div>
        </motion.div>
        ...
        >
          <h3 className="text-slate-700 font-bold text-sm mb-4">What's available now</h3>
          <div className="space-y-3">
            {[
              'Browse active service requests from verified clients',
              'Set up your portfolio with past work gallery',
              'View job details, locations & urgency ratings',
              'Access the Professional Workroom',
            ].map((benefit, i) => (
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-amber-800 text-sm font-bold mb-1">Unlock Quoting & Payments</p>
              <p className="text-amber-600 text-xs font-medium">
                To send quotes and receive milestone-based payments, verify your professional license/ID in the Trust Center. Funds are held in Houzii Escrow until job confirmation.
              </p>
            </div>
          </div>
        </motion.div>
