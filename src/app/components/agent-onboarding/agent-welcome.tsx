...
import { ShieldCheck, ArrowRight, Sparkles, Briefcase, Award } from 'lucide-react';
...
export const AgentWelcome: React.FC<AgentWelcomeProps> = ({ userName, onGoToDashboard }) => {
  return (
      ...
      >
        ...
        >
          ...
          <p className="text-slate-400 font-medium mb-2">
            Your agent profile is now
          </p>
          <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-green-50 border border-green-200 rounded-full mb-6">
            <ShieldCheck className="w-5 h-5 text-green-500" />
            <span className="text-green-600 font-black text-sm uppercase tracking-widest">Basic Verified</span>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="space-y-3">
            {[
              'Draft and manage property listings',
              'Receive and manage leads from seekers',
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-amber-800 text-sm font-bold mb-1">Unlock Commission Payouts</p>
              <p className="text-amber-600 text-xs font-medium">
                To unlock commission payouts and escrow features, we'll verify your license in your profile Trust Center later.
              </p>
            </div>
          </div>
        </motion.div>
