...
import { CircleCheckBig, ChevronRight, CalendarDays, PieChart, Users, TrendingUp } from "lucide-react";
import { ImageWithFallback } from "../figma/ImageWithFallback";

export const AgentCRMTools = () => {
  const features = [
    {
      title: "Client Management",
      icon: Users,
      description: "Organize buyers, sellers, and tenants in one secure, unified database."
    },
    {
      title: "Lead Tracking",
      icon: TrendingUp,
      description: "Monitor inquiries, track conversions, and analyze your sales funnel."
    },
    {
      title: "Viewing Scheduling",
      icon: CalendarDays,
      description: "Automate calendar invites and coordinate property tours effortlessly."
    },
    {
      title: "Commission Tracking",
      icon: PieChart,
      description: "Forecast earnings, manage splits, and track real-time revenue."
    }
  ];
          ...
          <div className="flex-1">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 shadow-sm mb-6 backdrop-blur-md">
                ...
                <span className="text-sm font-semibold text-slate-200">Advanced Agent Tools</span>
              </div>
              
              <h2 className="text-3xl md:text-5xl font-bold mb-6 leading-tight text-white">
                Powerful CRM built for <span className="text-[#C94B60]">Real Estate Teams</span>
              </h2>
              <p className="text-lg text-slate-300 mb-10 leading-relaxed max-w-xl">
                Streamline your operations, manage property portfolios, and close more deals with our integrated agent tools in a beautifully designed workspace.
              </p>
              ...
              <button className="h-14 px-8 rounded-full bg-[#7B2D42] text-white font-semibold text-lg hover:bg-[#C94B60] transition-colors flex items-center gap-2 shadow-lg shadow-[#7B2D42]/20 w-full sm:w-auto justify-center group">
                Explore CRM Features <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
            </motion.div>
          </div>
          ...
          >
            <div className="relative">
              ...
              >
                ...
                <div>
                  <p className="text-white font-bold text-sm">Deal Closed</p>
                  <p className="text-slate-400 text-xs">Commission earned: ₦1.2M</p>
                </div>
              </motion.div>
            </div>
          </motion.div>
