...
import { UserPlus, Home, MessageCircle, BriefcaseBusiness } from "lucide-react";
  ...
  const steps = [
    {
      ...
      description: "Sign up and build your professional real estate agent presence."
    },
    {
      icon: Home,
      title: "List Properties",
      description: "Upload properties or connect with verified property owners directly."
    },
    {
      icon: MessageCircle,
      title: "Manage Clients",
      description: "Receive inquiries, chat with leads, and schedule property viewings."
    },
    {
      icon: BriefcaseBusiness,
      title: "Close Deals",
      description: "Complete transactions securely and grow your real estate business."
    }
  ];
    ...
    <section className="py-24 bg-white/50 backdrop-blur-xl relative">
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            A simple, transparent process designed to help you succeed faster with Houzii.
          </motion.p>
        </div>
